...
caminaDerecha = [
    pygame.image.load("imagenes/principal/run1.png"),
...
caminaIzquierda = [
    pygame.image.load("imagenes/principal/run1-izq.png"),
...
salta = [
    pygame.image.load("imagenes/principal/jump1.png"),
...
while ejecuta:
    ...
    if (keys[pygame.K_a] or keys[pygame.K_LEFT]) and px > velocidad:
        px -= velocidad
        izquierda = True
        derecha = False

    # Tecla D - Moviemiento a la derecha
    elif (keys[pygame.K_d] or keys[pygame.K_RIGHT]) and px < 900 - velocidad - ancho:
        px += velocidad
        izquierda = False
        derecha = True
